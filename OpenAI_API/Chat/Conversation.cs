...
namespace OpenAI_API.Chat
{
    ...
    public class Conversation
    {
        ...
        /// <summary>
        /// After calling <see cref="GetResponseFromChatbotAsync"/>, this contains the full request object which was sent to the API.  This is overwritten with every call to <see cref="GetResponseFromChatbotAsync"/> and only contains the most recent request.
        /// </summary>
        public ChatRequest MostRecentApiRequest { get; private set; }
