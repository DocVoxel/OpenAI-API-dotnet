...
namespace OpenAI_API.Chat
{
    ...
    public class ChatRequest
    {
        ...
        /// <summary>
        /// Converts the request to a string that can be sent to the API
        /// </summary>
        /// <returns></returns>
        public string ToRequestJson()
        {
            string jsonContent = JsonConvert.SerializeObject(this, new JsonSerializerSettings() { NullValueHandling = NullValueHandling.Ignore });
            return jsonContent;
        }
    }
}
